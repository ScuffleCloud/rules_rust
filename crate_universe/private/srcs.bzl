...
CARGO_BAZEL_SRCS = [
    ...
    Label("//crate_universe:src/metadata/cargo_resolver.rs"),
    ...
    Label("//crate_universe:src/rendering/templates/partials/module/feature_flags_map.j2"),
    ...
    Label("//crate_universe:src/rendering/templates/partials/module/resolved_feature_flags_map.j2"),
