...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "cvm__wasi-0.14.3-wasi-0.2.4",
        ...
        build_file = Label("//vendor_remote_manifests/crates:BUILD.wasi-0.14.3+wasi-0.2.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//vendor_remote_manifests/crates:BUILD.wit-bindgen-0.45.0.bazel"),
    )
